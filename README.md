...
<body>
            ...
            <div class="header-container">
                ...
                <div class="user-menu">
                    <div class="user-info" id="user-dropdown-btn">
                        <div class="user-avatar" id="user-avatar">KC</div>
                        <span id="user-name-display">Keith Connell</span>
        ...
        <main class="banking-main">
            <div class="container">
                ...
                <div id="dashboard-page" class="page active">
                    <div class="dashboard-header">
                        <div class="welcome-section">
                            <h1 id="welcome-message">Welcome back, Keith</h1>
                ...
                <div id="fund-accounts-page" class="page">
                    ...
                    <p>Fund new premium accounts created under your referral code: <strong>CRB-KC-2025</strong></p>
                    ...
                    <div class="fund-account-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="referral-code" value="CRB-KC-2025" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="settings-container">
                        ...
                        <div class="settings-content">
                                ...
                                <form id="profile-form">
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="profile-name" value="Keith Connell">
                                        </div>
                                        <div class="form-group">
                                            <label>Quantum ID</label>
                                            <input type="text" class="form-control" id="profile-quantum-id" value="Q-KEITH-CONNELL-2025" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Secure Email</label>
                                            <input type="email" class="form-control" id="profile-email" value="ca2371643@gmail.com">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="profile-referral" value="CRB-KC-2025" readonly>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div id="referral-section" class="settings-section">
                                ...
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i>
                                    <span>Your referral code: <strong>CRB-KC-2025</strong>. Share this code with others to earn rewards.</span>
                                </div>
                                ...
                                <ol style="margin-left: 20px; margin-top: 15px;">
                                    <li>Share your referral code: <strong>CRB-KC-2025</strong></li>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="applicant-referral" placeholder="Enter referral code" value="CRB-KC-2025">
                    </div>
                </div>
    ...
    <script>
        const bankApp = {
            ...
            user: {
                name: "Keith Connell",
                username: "keithconnell2020",
                password: "myonlyworld",
                email: "ca2371643@gmail.com",
                otpCode: "12345678",
                isLoggedIn: false,
                quantumId: "Q-KEITH-CONNELL-2025",
                tier: "Elite Tier",
                referralCode: "CRB-KC-2025"
            },
            ...
            // Funded accounts
            fundedAccounts: [
                { id: 1, name: "John Smith", quantumId: "Q-JOHN-SMITH-2025", amount: 10000, date: '2025-11-15', referralCode: 'CRB-KC-2025' },
                { id: 2, name: "Sarah Johnson", quantumId: "Q-SARAH-J-2025", amount: 25000, date: '2025-11-10', referralCode: 'CRB-KC-2025' }
            ],
            ...
            // Transactions
            transactions: [
                { id: 1, type: "transfer", description: "Funded John Smith Account", amount: 10000, currency: "USD", date: "2025-11-15", status: "completed", time: "10:30 AM" },
                { id: 2, type: "transfer", description: "Funded Sarah Johnson Account", amount: 25000, currency: "USD", date: "2025-11-10", status: "completed", time: "2:15 PM" },
                { id: 3, type: "crypto", description: "Bitcoin Purchase", amount: 50000, currency: "USD", date: "2025-11-05", status: "completed", time: "9:45 AM" },
                { id: 4, type: "transfer", description: "International Wire - EUR", amount: 50000, currency: "EUR", date: "2025-10-28", status: "processing", time: "3:20 PM" },
                { id: 5, type: "transfer", description: "Zelle to Friend", amount: 500, currency: "USD", date: "2025-10-25", status: "completed", time: "11:10 AM" }
            ],
            ...
            fundAccount: function() {
                ...
                if (fundedUser) {
                    ...
                    fundedUser.transactions.push({
                        ...
                        type: "funding",
                        description: "Account funding by Keith Connell",
                        amount: amount,
                        date: new Date().toISOString().split('T')[0],
                        time: this.getCurrentTime(),
                        status: "completed",
                        fromAccount: "Keith Connell (CRB-KC-2025)"
                    });
                } else {
                ...
                // Add to Keith's funded accounts list
                const fundedAccount = {
                ...
                // Add transaction to Keith's history
                const transactionId = this.transactions.length + 1;
                const transaction = {
                    id: transactionId,
                    type: 'transfer',
            ...
            loadFundedAccounts: function() {
                ...
                this.fundedAccounts.forEach(account => {
                    const element = document.createElement('div');
                    ...
                    element.innerHTML = `
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            <div>
                                ...
                                <div style="font-size: 0.9rem; color: var(--medium-gray);">${account.quantumId}</div>
                            </div>
                            <div class="badge badge-success">Funded</div>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Amount</div>
                            <div style="font-size: 1.2rem; font-weight: 600; color: var(--accent-green);">$${this.formatCurrency(account.amount)}</div>
                        </div>
                        <div style="font-size: 0.85rem; color: var(--medium-gray); margin-top: 10px; margin-bottom: 15px;">Date: ${account.date} • Referral: ${account.referralCode}</div>
                        <button class="btn btn-secondary btn-sm view-user-account" data-user-id="${account.quantumId}" style="width: 100%;">
                            <i class="fas fa-eye"></i> View Account Details
                        </button>
                    `;
                    container.appendChild(element);
                });
                ...
                document.querySelectorAll('.view-user-account').forEach(button => {
                    button.addEventListener('click', (e) => {
                        const quantumId = e.currentTarget.getAttribute('data-user-id');
                        this.viewFundedUserAccount(quantumId);
                    });
                });
            },
            
            // View funded user account
            viewFundedUserAccount: function(quantumId) {
                const fundedUser = this.fundedUsers.find(user => user.quantumId === quantumId);
                
                if (!fundedUser) {
                    this.showAlert('User account not found', 'error');
                    return;
                }
                
                // Create modal to display user account details
                const modalHtml = `
                    <div id="user-account-modal" class="modal active">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2>${fundedUser.name}'s Account</h2>
                                <button class="modal-close" id="user-account-close">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div style="margin-bottom: 30px;">
                                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 20px;">
                                        <div style="background-color: rgba(0, 0, 0, 0.03); padding: 20px; border-radius: var(--radius);">
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Current Balance</div>
                                            <div style="font-size: 2rem; font-weight: 700; color: var(--primary-blue);">$${this.formatCurrency(fundedUser.currentBalance)}</div>
                                        </div>
                                        <div style="background-color: rgba(0, 0, 0, 0.03); padding: 20px; border-radius: var(--radius);">
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Original Funding</div>
                                            <div style="font-size: 2rem; font-weight: 700; color: var(--accent-green);">$${this.formatCurrency(fundedUser.originalBalance)}</div>
                                        </div>
                                    </div>
                                    
                                    <div style="margin-top: 20px;">
                                        <div style="font-size: 0.9rem; color: var(--medium-gray);">Account Details</div>
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-top: 10px;">
                                            <div><strong>Username:</strong> ${fundedUser.username}</div>
                                            <div><strong>Quantum ID:</strong> ${fundedUser.quantumId}</div>
                                            <div><strong>Status:</strong> <span class="badge badge-success">${fundedUser.status}</span></div>
                                            <div><strong>Created:</strong> ${fundedUser.createdDate}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="max-height: 300px; overflow-y: auto; margin-top: 20px;">
                                    ${this.generateUserTransactionsHtml(fundedUser)}
                                </div>
                                
                                <div style="margin-top: 30px; display: flex; gap: 10px;">
                                    <button class="btn btn-primary" id="add-funds-btn" data-user-id="${fundedUser.quantumId}">
                                        <i class="fas fa-plus"></i> Add More Funds
                                    </button>
                                    <button class="btn btn-secondary" id="view-login-details-btn" data-user-id="${fundedUser.quantumId}">
                                        <i class="fas fa-key"></i> View Login Details
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                document.getElementById('user-account-close').addEventListener('click', () => {
                    document.getElementById('user-account-modal').remove();
                });
                
                document.getElementById('add-funds-btn').addEventListener('click', (e) => {
                    const userId = e.currentTarget.getAttribute('data-user-id');
                    this.addFundsToUser(userId);
                });
                
                document.getElementById('view-login-details-btn').addEventListener('click', (e) => {
                    const userId = e.currentTarget.getAttribute('data-user-id');
                    this.showUserLoginDetails(userId);
                });
            },
            
            // Generate user transactions HTML
            generateUserTransactionsHtml: function(fundedUser) {
                if (!fundedUser.transactions || fundedUser.transactions.length === 0) {
                    return '<div style="text-align: center; padding: 40px; color: var(--medium-gray);">No transactions yet</div>';
                }
                
                let html = '';
                fundedUser.transactions.forEach(transaction => {
                    html += `
                        <div style="padding: 15px; border-bottom: 1px solid rgba(0,0,0,0.1);">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <div style="font-weight: 600;">${transaction.description}</div>
                                    <div style="font-size: 0.85rem; color: var(--medium-gray);">${transaction.date} • ${transaction.time}</div>
                                </div>
                                <div style="font-weight: 700; color: var(--accent-green);">+$${this.formatCurrency(transaction.amount)}</div>
                            </div>
                            <div style="font-size: 0.85rem; color: var(--medium-gray); margin-top: 5px;">
                                From: ${transaction.fromAccount} • Status: <span class="badge badge-success">${transaction.status}</span>
                            </div>
                        </div>
                    `;
                });
            ...
            // Add funds to a user
            addFundsToUser: function(quantumId) {
                const fundedUser = this.fundedUsers.find(user => user.quantumId === quantumId);
                ...
                const amount = prompt(`Enter amount to add to ${fundedUser.name}'s account:`, "1000");
                ...
                // Check if Keith has sufficient funds (using checking account)
                if (fundingAmount > this.accounts.checking) {
                    this.showAlert('Insufficient funds in your account', 'error');
                    return;
                }
                
                // Deduct from Keith's account
                this.accounts.checking -= fundingAmount;
                
                // Add to user's account
                fundedUser.currentBalance += fundingAmount;
                ...
                fundedUser.transactions.push({
                    ...
                    description: "Additional funding by Keith Connell",
                ...
                const fundedAccount = {
                    id: this.fundedAccounts.length + 1,
                    name: fundedUser.name,
                    quantumId: fundedUser.quantumId,
                    amount: fundingAmount,
                    date: new Date().toISOString().split('T')[0],
                    referralCode: 'CRB-KC-2025'
                };
                ...
                const transaction = {
                    id: transactionId,
                    type: 'transfer',
                    description: `Additional funding for ${fundedUser.name}`,
                    amount: fundingAmount,
                    currency: 'USD',
                    date: new Date().toISOString().split('T')[0],
                    status: 'completed',
                ...
                this.showAlert(`Successfully added $${this.formatCurrency(fundingAmount)} to ${fundedUser.name}'s account`, 'success');
            ...
            showUserLoginDetails: function(quantumId) {
                const fundedUser = this.fundedUsers.find(user => user.quantumId === quantumId);
                ...
                this.showAlert(`Login details for ${fundedUser.name}: Username: ${fundedUser.username}, Password: ${fundedUser.password}`, 'info');
            },
            ...
            showNewAccountModal: function() {
                ...
                // Add event listeners for password toggles in new account modal
                setTimeout(() => {
                    const applicantTogglePassword = document.getElementById('applicant-toggle-password');
                    const applicantToggleConfirmPassword = document.getElementById('applicant-toggle-confirm-password');
                    
                    if (applicantTogglePassword) {
                        applicantTogglePassword.addEventListener('click', () => {
                            const passwordInput = document.getElementById('applicant-password');
                            if (passwordInput.type === 'password') {
                                passwordInput.type = 'text';
                                applicantTogglePassword.innerHTML = '<i class="fas fa-eye-slash"></i>';
                            } else {
                                passwordInput.type = 'password';
                                applicantTogglePassword.innerHTML = '<i class="fas fa-eye"></i>';
                            }
                        });
                    }
                    
                    if (applicantToggleConfirmPassword) {
                        applicantToggleConfirmPassword.addEventListener('click', () => {
                            const passwordInput = document.getElementById('applicant-confirm-password');
                            if (passwordInput.type === 'password') {
                                passwordInput.type = 'text';
                                applicantToggleConfirmPassword.innerHTML = '<i class="fas fa-eye-slash"></i>';
                            } else {
                                passwordInput.type = 'password';
                                applicantToggleConfirmPassword.innerHTML = '<i class="fas fa-eye"></i>';
                            }
                        });
                    }
                }, 100);
            ...
            createNewAccount: function() {
                ...
                const dob = document.getElementById('applicant-dob').value;
                const initialDeposit = parseFloat(document.getElementById('initial-deposit').value);
                const referralCode = document.getElementById('applicant-referral').value;
                ...
                if (!name || !email || !phone || !dob || !initialDeposit || !password || !confirmPassword) {
                    this.showAlert('Please fill all required fields', 'error');
                    return;
                }
                ...
                if (initialDeposit < 1000) {
                    this.showAlert('Minimum initial deposit is $1,000', 'error');
                    return;
                }
                ...
                const quantumId = `Q-${firstName}-${lastName}-${new Date().getFullYear()}`;
                
                // Generate username
                const username = email.split('@')[0].toLowerCase().replace(/[^a-z0-9]/g, '') + new Date().getFullYear();
                
                // Create new user for Keith's records
                const newUser = {
                ...
                // ALSO CREATE A FUNDED USER ACCOUNT
                const fundedUser = {
                    id: this.fundedUsers.length + 1,
                    name: name,
                    username: username,
                    ...
                    email: email,
                    quantumId: quantumId,
                    originalBalance: initialDeposit,
                    currentBalance: initialDeposit,
                    transactions: [
                        {
                            id: 1,
                            type: "initial_deposit",
                            description: "Initial account funding by Keith Connell",
                ...
                this.fundedUsers.push(fundedUser);
                ...
                this.showAlert(`New premium account created! Quantum ID: ${quantumId}, Username: ${username}. The user can now log in with their chosen password.`, 'success');
                ...
                document.getElementById('applicant-dob').value = '';
                document.getElementById('initial-deposit').value = '10000';
                document.getElementById('applicant-password').value = '';
                document.getElementById('applicant-confirm-password').value = '';
            },
            ...
            initializeLoginHistory: function() {
                this.loginHistory = [
                    { id: 1, date: '2025-11-30', time: '10:15 AM', location: 'San Francisco, CA', device: 'Chrome on Mac', ip: '192.168.1.100', status: 'success' },
                    { id: 2, date: '2025-11-29', time: '8:30 PM', location: 'Los Angeles, CA', device: 'Safari on iPhone', ip: '192.168.1.101', status: 'success' },
                    { id: 3, date: '2025-11-28', time: '2:45 PM', location: 'New York, NY', device: 'Firefox on Windows', ip: '192.168.1.102', status: 'success' },
                    { id: 4, date: '2025-11-27', time: '9:20 AM', location: 'Miami, FL', device: 'Chrome on Android', ip: '192.168.1.103', status: 'success' }
                ];
            },
            
            // Add login history
            addLoginHistory: function(action) {
                const record = {
            ...
            loadLoginHistory: function() {
                ...
                html += '<thead><tr><th>Date & Time</th><th>Location</th><th>Device</th><th>IP Address</th><th>Status</th></tr></thead>';
                html += '<tbody>';
                ...
                this.loginHistory.forEach(record => {
                    html += `
                        <tr>
                            ...
                            <td>${record.device}</td>
                            <td>${record.ip}</td>
                            <td><span class="badge ${record.status === 'success' || record.status === 'Login successful' ? 'badge-success' : 'badge-danger'}">${record.status.toUpperCase()}</span></td>
                        </tr>
                    `;
                });
            ...
            loadFundedUsersList: function() {
                ...
                if (this.fundedUsers.length === 0) return;
                
                const usersListHtml = `
                    <div id="funded-users-list" style="margin-top: 30px;">
                        <h3>Funded Users (${this.fundedUsers.length})</h3>
                        <div style="margin-top: 20px; max-height: 300px; overflow-y: auto;">
                            <table class="login-history-table">
                                ...
                                <tbody>
                                    ${this.fundedUsers.map(user => `
                                        <tr>
                                            <td>${user.name}</td>
                                            <td>${user.quantumId}</td>
                                            <td>$${this.formatCurrency(user.currentBalance)}</td>
                                            <td>${user.createdDate}</td>
                                            <td>
                                                <button class="btn btn-secondary btn-sm view-user-btn" data-user-id="${user.quantumId}" style="padding: 5px 10px; font-size: 0.8rem;">
            ...
            changePassword: function() {
                this.showAlert('For security, please contact Quantum Security at vp89735270@hotmail.com to change your password.', 'info');
            },
            
            // Contact security
            contactSecurity: function() {
                this.showAlert('Quantum Security Center: vp89735270@hotmail.com | 24/7 Support', 'info');
            },
            ...
            showAlert: function(message, type) {
                ...
                const mainContent = document.querySelector('.banking-main .container');
                if (mainContent) {
            ...
            showUserLoginPage: function() {
                const loginModalHtml = `
                    <div id="user-login-modal" class="modal active">
                        <div class="modal-content" style="max-width: 500px;">
                            <div class="modal-header">
                                <h2>User Account Login</h2>
                                <button class="modal-close" id="user-login-close">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div class="login-header" style="margin-bottom: 30px;">
                                    <div class="login-logo">
                                        ...
                                        <div>
                                            <h3>Funded Account Access</h3>
                                            <p>Login to view your funded account</p>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="user-login-username">Username or Quantum ID</label>
                                    <input type="text" id="user-login-username" class="form-control" placeholder="Enter your username or Quantum ID">
                                </div>
                                
                                <div class="form-group">
                                    <label for="user-login-password">Password</label>
                                    <div class="password-field">
                                        <input type="password" id="user-login-password" class="form-control" placeholder="Enter your password">
                                        <button type="button" class="toggle-password" id="user-toggle-password">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                    </div>
                                </div>
                                
                                <button class="btn btn-primary" id="user-login-submit" style="width: 100%; margin-top: 20px;">
                                    <i class="fas fa-sign-in-alt"></i> Login to Account
                                </button>
                                
                                <div class="login-footer" style="margin-top: 30px; text-align: center;">
                                    <p>Don't have login details? Contact Keith Connell at <strong>CRB-KC-2025</strong></p>
                                    <p>Or email: vp89735270@hotmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                document.getElementById('user-login-close').addEventListener('click', () => {
                    document.getElementById('user-login-modal').remove();
                });
                
                document.getElementById('user-toggle-password').addEventListener('click', () => {
                    const passwordInput = document.getElementById('user-login-password');
                    const toggleButton = document.getElementById('user-toggle-password');
                ...
                document.getElementById('user-login-submit').addEventListener('click', () => {
                    this.handleUserLogin();
                });
                
                document.getElementById('user-login-modal').addEventListener('click', (e) => {
                    if (e.target.id === 'user-login-modal') {
                        document.getElementById('user-login-modal').remove();
                    }
                });
            },
            ...
            handleUserLogin: function() {
                ...
                const user = this.fundedUsers.find(u => 
                    u.username === username || u.quantumId === username
                );
                
                if (!user) {
                    this.showAlert('Account not found. Please check your credentials.', 'error');
                    return;
                }
            ...
            // Show user dashboard
            showUserDashboard: function(user) {
                const dashboardHtml = `
                    <div id="user-dashboard" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: var(--light-gray); z-index: 9999; overflow-y: auto;">
                        <header class="banking-header">
                            <div class="header-container">
                                <div class="bank-logo">
                                    <div class="bank-logo-icon">
                                ...
                                <div class="user-menu">
                                    <div class="user-info">
                                        <div class="user-avatar">${user.name.charAt(0)}${user.name.split(' ')[1]?.charAt(0) || user.name.charAt(1)}</div>
                                        <span>${user.name}</span>
                                    </div>
                                    
                                    <button id="user-logout-btn" class="logout-btn">
                                        <i class="fas fa-sign-out-alt"></i> Logout
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <div class="dashboard-header">
                                    <div class="welcome-section">
                                        ...
                                        <p>Your funded account dashboard • Quantum ID: ${user.quantumId}</p>
                                        <div class="account-status mt-20" style="background: linear-gradient(135deg, var(--accent-green), #00c853);">
                                            <i class="fas fa-check-circle"></i>
                                            <span>Account Active • Balance: $${this.formatCurrency(user.currentBalance)}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accounts-grid">
                                    <div class="account-card">
                                        <div class="account-type">
                                            <h3><i class="fas fa-university"></i> Primary Account</h3>
                                        </div>
                                        <div class="account-balance">$${this.formatCurrency(user.currentBalance)}</div>
                                        <div class="account-number">Quantum ID: ${user.quantumId}</div>
                                        <div class="account-number">Managed by: Keith Connell (CRB-KC-2025)</div>
                                    </div>
                                    ...
                                    <div class="account-card gold">
                                        ...
                                        <div style="font-size: 1.5rem; font-weight: 700; margin-bottom: 15px;">${user.transactions.length} Transactions</div>
                                        <div class="account-number">Last activity: ${user.transactions[0]?.date || user.createdDate}</div>
                                        <div class="account-actions">
                                            <button class="btn btn-primary btn-sm" id="view-all-transactions-user">
                                                View All Transactions
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="recent-transactions">
                                    <div class="transactions-header">
                                        <h2>Recent Transactions</h2>
                                        <button class="btn btn-primary" id="view-full-history">
                                            View Full History
                                        </button>
                                    </div>
                                    <div id="user-transactions-list">
                                        ${this.generateUserRecentTransactionsHtml(user)}
                                    </div>
                                </div>
                                
                                <!-- Account Information -->
                                <div class="fund-account-section mt-40">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            <label>Quantum ID</label>
                                            <input type="text" class="form-control" value="${user.quantumId}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="${user.createdDate}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Original Funding</label>
                                            <input type="text" class="form-control" value="$${this.formatCurrency(user.originalBalance)}" readonly style="background-color: rgba(0, 168, 107, 0.1); color: var(--accent-green);">
                                        </div>
                                        <div class="form-group">
                                            <label>Current Balance</label>
                                            <input type="text" class="form-control" value="$${this.formatCurrency(user.currentBalance)}" readonly style="background-color: rgba(0, 43, 92, 0.1); color: var(--primary-blue);">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info mt-30">
                                    <i class="fas fa-info-circle"></i>
                                    <span>This account is managed by Keith Connell. For additional funding or account inquiries, contact: <strong>CRB-KC-2025</strong> or email: vp89735270@hotmail.com</span>
                                </div>
                            </div>
                        </main>
                    </div>
                ...
                document.getElementById('user-logout-btn').addEventListener('click', () => {
                    document.getElementById('user-dashboard').remove();
                    this.showAlert('Logged out successfully', 'success');
                });
                
                document.getElementById('view-all-transactions-user').addEventListener('click', () => {
                    this.showUserTransactionHistory(user);
                });
                ...
                document.querySelectorAll('#user-transactions-list .transaction-item').forEach(item => {
                    item.addEventListener('click', () => {
                        const transactionId = item.getAttribute('data-transaction-id');
                        const transaction = user.transactions.find(t => t.id == transactionId);
                        if (transaction) {
                            this.showUserTransactionDetail(item, user);
                        }
                    });
                });
            },
            ...
            showUserTransactionHistory: function(user) {
                const modalHtml = `
                    <div id="user-transaction-history-modal" class="modal active">
                        <div class="modal-content" style="max-width: 800px;">
                            <div class="modal-header">
                                <h2>Complete Transaction History</h2>
                                <button class="modal-close" id="user-history-close">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div style="margin-bottom: 20px;">
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        <div>
                                            ...
                                            <div style="color: var(--medium-gray);">Quantum ID: ${user.quantumId}</div>
                                        </div>
                                        ...
                                        <tbody>
                                            ${user.transactions.map(transaction => `
                                                <tr>
                                                    ...
                                                    <td style="font-weight: 600; color: var(--accent-green);">+$${this.formatCurrency(transaction.amount)}</td>
                                ...
                                <div style="margin-top: 30px; text-align: center;">
                                    <div style="display: inline-grid; grid-template-columns: repeat(3, 1fr); gap: 30px; text-align: center;">
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Total Transactions</div>
                                            <div style="font-size: 2rem; font-weight: 700;">${user.transactions.length}</div>
                                        </div>
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Total Received</div>
                                            <div style="font-size: 2rem; font-weight: 700; color: var(--accent-green);">$${this.formatCurrency(user.currentBalance)}</div>
                                        </div>
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Account Since</div>
                                            <div style="font-size: 1.2rem; font-weight: 700;">${user.createdDate}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                document.getElementById('user-history-close').addEventListener('click', () => {
                    document.getElementById('user-transaction-history-modal').remove();
                });
            },
            
            // Show user transaction detail
            showUserTransactionDetail: function(transactionElement, user) {
                ...
                const modalHtml = `
                    <div id="user-transaction-detail-modal" class="modal active">
                        <div class="modal-content" style="max-width: 600px;">
                            <div class="modal-header">
                                <h2>Transaction Details</h2>
                                <button class="modal-close" id="user-transaction-close">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div style="text-align: center; margin-bottom: 30px;">
                                    <div style="font-size: 2.5rem; color: var(--accent-green); margin-bottom: 10px;">
                                        <i class="fas fa-check-circle"></i>
                                    </div>
                                    <div style="font-size: 1.2rem; font-weight: 600;">${transaction.description}</div>
                                </div>
                                
                                <div style="background-color: rgba(0, 0, 0, 0.03); padding: 25px; border-radius: var(--radius); margin-bottom: 25px;">
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Amount</div>
                                            <div style="font-size: 1.8rem; font-weight: 700; color: var(--accent-green);">$${this.formatCurrency(transaction.amount)}</div>
                                        </div>
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Date</div>
                                            <div style="font-size: 1.2rem; font-weight: 600;">${transaction.date}</div>
                                        </div>
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Time</div>
                                            <div style="font-size: 1.2rem; font-weight: 600;">${transaction.time}</div>
                                        </div>
                                        <div>
                                            <div style="font-size: 0.9rem; color: var(--medium-gray);">Status</div>
                                ...
                                <div style="margin-bottom: 25px;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr; gap: 10px; margin-top: 15px;">
                                        ...
                                        <div><strong>To:</strong> ${user.name} (${user.quantumId})</div>
                                        <div><strong>Transaction ID:</strong> CRB-${transaction.id.toString().padStart(8, '0')}</div>
                                        <div><strong>Type:</strong> Account Funding</div>
                                    </div>
                                </div>
                                
                                <div style="background-color: rgba(0, 43, 92, 0.05); padding: 20px; border-radius: var(--radius);">
                                    <h4><i class="fas fa-shield-alt"></i> Security Information</h4>
                                    <p style="margin-top: 10px; font-size: 0.95rem;">This transaction was processed through California Regional Bank's Quantum Network with 256-bit encryption. The funds have been successfully transferred and are available in your account.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                document.getElementById('user-transaction-close').addEventListener('click', () => {
                    document.getElementById('user-transaction-detail-modal').remove();
                });
            }
        };
